...
public interface FileStorageService {
    ...
    record ResourceDetail(UUID id, String name, String contentType, String mediaType ) { }
    record ResourceContent(UUID id, String name, String contentType, String mediaType, Optional<byte[]> content ) { }
     ...
     * En ese caso, el {@link ResourceContent#content()} devolverá
    ...
    static Path amountFileToPath(Path dirPath, String filename) {
        if (dirPath == null || !Files.isDirectory(dirPath) || !Files.isReadable(dirPath) || !Files.isWritable(dirPath)) {
            throw new IllegalArgumentException("Directory path is invalid or not accessible");
        }
